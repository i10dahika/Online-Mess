				...
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab"
						...
						<a class="nav-link " id="v-pills-home-tab" data-toggle="pill"
							...
							aria-selected="true">All</a> <a class="nav-link"
							id="v-pills-profile-tab" data-toggle="pill"
							href="#v-pills-profile" role="tab"
							aria-controls="v-pills-profile" aria-selected="false">Veg</a> <a
							class="nav-link" id="v-pills-messages-tab" data-toggle="pill"
							href="#v-pills-messages" role="tab"
							aria-controls="v-pills-messages" aria-selected="false">Non Veg</</a>
						<a class="nav-link" id="v-pills-settings-tab" data-toggle="pill"
							href="#v-pills-settings" role="tab"
							aria-controls="v-pills-settings" aria-selected="false">Show Menu</a>
					</div>
				</div>
								...
								<form action="AddProduct" method="post">
									...
									<div style="border-style: ridge;">
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="txt_Uname"
													style="color: black; font-size: 18px;">Special Rice</label>
												<select class="custom-select d-block form-control"
										...
										<div class="col-md-12">
											...
											<input class="btn btn-common" type="submit" name=bt value="veg" ></input>
							...
							<div>
								...
								<form action="AddProduct" method="post">
									...
									<div style="border-style: ridge;">
										...
										<div class="col-md-12">
											<div class="submit-button text-center">
												<input class="btn btn-common" type="submit" name=bt value="Non Veg" ></input>
