...
<table id="myTable" class="table table-striped">  
        <thead>  
          <tr>  
           <th>ID</th>
            <th>Bhaji_Name_first</th>  
            <th>Bhaji_Name_second</th>  
            <th>Roti_name</th>
            <th>Rice_name</th> 
             <th>Price</th>  
            <th>Order Qty</th>  
	...
	ResultSet rs=st.executeQuery("select * from order_menu_info where  mess_owner_email='"+email+"' and user_email='"+User_Email_ID+"' and id='"+id+"'");
	while(rs.next())
	{
