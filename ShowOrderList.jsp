...
<table id="myTable" class="table table-striped">  
	...
	ResultSet rs=st.executeQuery("select * from order_menu_info where mess_owner_email='" + email + "' and Status_info='Sending'");
	while(rs.next())
	{
		id=rs.getString(1);
...
%>
			...
			<td ><%=bhaji_Name_first %></td>
			<td ><%=bhaji_Name_second %></td>
			<td ><%=roti_name %></td>
			<td ><%=rice_name %></td>
			<td ><%=price %></td>
	...
	%>
	 ...
	 <tr>
        <td colspan="6" align="center">
              <input type="submit" class="btn btn-common" value="Save"></td>
        </tr>
        </tbody>  
      </table>
	</form>
